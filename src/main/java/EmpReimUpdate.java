...
/**
 * Servlet implementation class EmpReimUpdate
 */
@WebServlet("/EmpReimUpdate")
public class EmpReimUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmpReimUpdate() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try (Connection con = ConnectionUtil.getConnection();
	    	...
	    	stmt.setInt(1, gen.returnActiveEmp().getEmpNo());
	   ...
	   // System.out.println(result);
	    ...
	    fooWriter.write("\n]");
		fooWriter.close();
		RequestDispatcher rd=request.getRequestDispatcher("/EmployeeReimburse.jsp");  
